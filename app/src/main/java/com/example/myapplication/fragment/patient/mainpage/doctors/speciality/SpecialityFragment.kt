...
class SpecialityFragment : Fragment(), SpecialityAdapter.MyClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        adapter = SpecialityAdapter(specialityList, this@SpecialityFragment)
    ...
    override fun onClick(position: Int) {
        val action = SpecialityFragmentDirections.actionSpecialityToDoctors(heading[position])
